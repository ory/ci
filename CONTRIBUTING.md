...
# Contribute to Ory ci<!-- omit in toc -->
...
_Please note_: We take Ory ci's security and our users' trust very
seriously. If you believe you have found a security issue in Ory ci,
...
ci's direction. A great way to
do this is via
[Ory ci Discussions](https://github.com/orgs/ory/discussions)
or the [Ory Chat](https://www.ory.sh/chat).

## FAQ

- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/ory/ci/blob/master/CODE_OF_CONDUCT.md)

- I have a question. Where can I get
  [answers to questions regarding Ory ci?](#communication)
...
- I want to talk to other Ory ci users.
  [How can I become a part of the community?](#communication)

- I would like to know what I am agreeing to when I contribute to Ory
  ci.
  Does Ory have
  [a Contributors License Agreement?](https://cla-assistant.io/ory/ci)

- I would like updates about new versions of Ory ci.
...
[list of good first issues](https://github.com/ory/ci/labels/good%20first%20issue).

There are many other ways you can contribute. Here are a few things you can do
to help out:

- **Give us a star.** It may not seem like much, but it really makes a
  difference. This is something that everyone can do to help out Ory ci.
...
- **Help with open issues.** We have a lot of open issues for Ory ci and
...
Check out [Ory ci Discussions](https://github.com/orgs/ory/discussions). This is a great place for
...
If you want to receive regular notifications about updates to Ory ci,
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/ci/blob/master/.github/workflows/conventional_commits.yml)
...
before getting started to ensure your work is consistent with Ory ci's
...
[Contributor License Agreement](https://cla-assistant.io/ory/ci).
...
git clone git@github.com:ory/ory/ci.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/ory/ci.git
